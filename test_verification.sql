...
INSERT INTO orders (user_id, customer_name, customer_phone, total_price, status, created_at)
VALUES (
...
-- The reason you didn't see old data was likely due to ID mismatch or empty tables.
